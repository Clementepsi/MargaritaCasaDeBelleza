...
const teamData = [
    ...
    },
    {
        ...
        description: "• 10 veces menos caída en cada uso <br>• Fórmula sin sal <br> • Ayuda a reducir la caída del cabello debido al quiebre Libre de químicos. <br>• Ayuda a prevenir la caída formando un cabello más fuerte desde la raíz hasta las puntas. ",
        isPromo: false,
        isNew: false,
        size: "500ml",
        price: 280
    ...
    },
    {
        ...
        name: "Gotas de seda",
        description: "Las gotas de seda MARGARITA ofrecen un brillo excepcional y controlan el esponjado del cabello. Su formula ligera es ideal para todo tipo de cabello y no deja residuos. ",
        isPromo: false,
        isNew: false,
        size: "90ml",
        price: 120
    },
    {
        ...
        name: "Botox Capilar",
        description: "Hidrata y le da brillo al cabello, dejándolo más bonito, un poco más liso, sin frizz y sin horquetillas. A pesar de que el nombre de este tratamiento contiene la palabra botox, estos productos no contienen la toxina botulinica. Teniendo este nombre porque renueva el cabello corrigiendo daños. ",
        isPromo: true,
        isNew: false,
        size: "50ml",
        price: 120
...

    {
        ...
        description: " Jabón de lavanda 100% natural libre de tóxicos, brinda suavidad a la piel, Tiene propiedades antisépticas, previene el acné y ayuda a tratar inflamaciones, quemaduras y afecciones cutáneas como la psoriasis.",
        isPromo: false,
        isNew: false,
        size: "15g",
        price: 160
    ...
    },
    {
        ...
        description: "El suero crecimiento de pestañas, MARGARITA ha sido formulado para las mujeres que desean tener pestañas mas largas, abundantes y fuertes. Es perfecto para esas mujeres que tienen pestañas naturalmente pequeñas y débiles, que usan pestañas postizas o han usado extensiones de pestañas. La fórmula hace pestañas más largas y gruesas. se puede tener hermosas pestañas en muy poco tiempo. ",
        isPromo: false,
        isNew: false,
        size: "15g",
        price: 160
    ...
    },
    {
        ...
        description: "Formulada para limpiar a profundidad cualquier tipo de piel y eliminar poros obstruidos. La arcilla  purifica la piel y se seca por completo 20 minutos después de usarla, dejando la piel libre de bacterias y poros obstruidos.",
        isPromo: false,
        isNew: false,
        size: "100ml",
        price: 159
